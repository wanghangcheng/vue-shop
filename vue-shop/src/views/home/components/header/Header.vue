<template>
    <div class="wrapper">
        <div class="locationWrapper">
            ...
            <span class="address">{{city || '北京市'}}</span>
...
<script>
    export default {
        ...
        methods:{
            //初始化地图
            initMap(){
                let geolocation = new qq.maps.Geolocation("HUMBZ-AFVRO-7IAWH-SKKR5-3SMOQ-BGF7P","app");
                geolocation.getIpLocation(this.showPosition, this.showError);
            },
            //成功回调
